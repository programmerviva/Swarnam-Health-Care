    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          <p>
            Welcome to Swarnam Health Care, your trusted partner in managing
            your healthcare needs conveniently and efficiently. At Swarnam
            Health Care, we understand the challenges individuals face when it
            comes to scheduling doctor appointments and managing their health
            records.
          </p>
          <p>
            Swarnam Health Care is committed to excellence in healthcare
            ...
            appointment or managing ongoing care, Prescripto is here to support
            you every step of the way.
          </p>
          <b className="text-gray-800">Our Vision</b>
          <p>
            Our vision at Swarnam Health Care is to create a seamless healthcare
